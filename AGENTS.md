...
- Build scripts have been replaced by Vite plugins (`cssBuildPlugin`, `clientBuildPlugin`, `schemaPlugin`, `handlerRegistryPlugin`, `sqlTypesPlugin`, `sqlTransformPlugin`).
